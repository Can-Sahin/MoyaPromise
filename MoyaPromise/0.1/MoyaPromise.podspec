#
#  Be sure to run `pod spec lint MoyaPromise.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Can-Sahin"
  # s.authors            = { "Can-Sahin" => "cann2005@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Can-Sahin"
